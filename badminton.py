...
# Load Data
H2H = pd.read_csv("C:/Users/xings/Documents/H2H.csv")
# Interface
...
service = st.selectbox("Choose what you want to do: ", ["Search", "Add","Update"])
...
if service == "Search":
    ...
    if check:
        H2H = H2H_copy
        H2H.to_csv("C:/Users/xings/Documents/H2H.csv",index=False)
